...
@ListenerFor(sourceClass = AdamantiumMenu.class, systemEventClass = PostAddToViewEvent.class)
public class AdamantiumMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {
