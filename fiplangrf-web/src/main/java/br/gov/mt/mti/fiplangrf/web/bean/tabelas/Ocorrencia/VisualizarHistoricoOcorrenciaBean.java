...
@Named("visualizarHistoricoOcorrenciaBean")
@ViewScoped
@URLMappings(mappings = {
		@URLMapping(id = "VisualizarHistoricoOcorrencia", pattern = "/ocorrencia/visualizarHistorico/#{id: visualizarHistoricoOcorrenciaBean.id}", viewId = "/pages/tabelas/ocorrencia/visualizarHistoricoOcorrencia.jsf") })
public class VisualizarHistoricoOcorrenciaBean extends HistoricoEnversBean<Ocorrencia,Long> {

    private static final long serialVersionUID = 997893526221509035L;

    private static final Logger LOGGER = LoggerFactory.getLogger(VisualizarHistoricoOcorrenciaBean.class);

	public static final String HISTORICO_VIEW = "pretty:VisualizarHistoricoOcorrencia";
	...
	@Override
	protected Class<Ocorrencia> getType() {
	...
	public void pesquisar(ActionEvent event) {
		LOGGER.debug("Pesquisando registros de Ocorrencia: {}", criteria);
