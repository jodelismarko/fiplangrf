...
@Named("visualizarHistoricoNaturezaJuridicaBean")
@ViewScoped
@URLMappings(mappings = {
		@URLMapping(id = "visualizarHistoricoNaturezaJuridica", pattern = "/naturezajuridica/visualizarHistorico/#{id: visualizarHistoricoNaturezaJuridicaBean.id}", viewId = "/pages/tabelas/naturezaJuridica/visualizarHistoricoNaturezaJuridica.jsf") })
public class VisualizarHistoricoNaturezaJuridicaBean extends HistoricoEnversBean<NaturezaJuridica,Long> {

    private static final long serialVersionUID = 997893526221509035L;

    private static final Logger LOGGER = LoggerFactory.getLogger(VisualizarHistoricoNaturezaJuridicaBean.class);

	public static final String HISTORICO_VIEW = "pretty:visualizarHistoricoNaturezaJuridica";
	...
	@Override
	protected Class<NaturezaJuridica> getType() {
	...
	public void pesquisar(ActionEvent event) {
		LOGGER.debug("Pesquisando registros de Natureza Juridica: {}", criteria);
