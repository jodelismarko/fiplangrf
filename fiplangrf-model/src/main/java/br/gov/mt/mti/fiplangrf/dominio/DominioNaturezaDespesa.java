...
public enum DominioNaturezaDespesa {
	...
	public static final String NOME = "DominioNaturezaDespesa";
	public static final String METHOD = "getCharCod";

	private String desc;
	private String charCod;

	private DominioNaturezaDespesa(String charCod, String desc) {
	...
	public static List<SelectItem> getItems() {
		...
		for (DominioNaturezaDespesa dominio : values()) {
